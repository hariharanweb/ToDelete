(function() {
  ...
  calatrava.inbound = {
    ...
    successfulRespone: function(requestId, response) {
    ...
    invokeCallback: function(widgetName) {
      var extraArgs;
      extraArgs = _.map(_.toArray(arguments).slice(1), (function(obj) {
        if (obj != null) return obj.valueOf();
      }));
      return calatrava.bridge.widgets.callback(widgetName).apply(this, extraArgs);
    }
  };
  ...
  calatrava.bridge.alert = function(message) {
    return calatrava.bridge.runtime.alert(message);
  };
